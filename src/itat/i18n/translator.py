...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "menu_opt4": "Specialized Support Skills (MySQL, PostgreSQL, PowerBI, Docker, Web)",
    ...
    "es": {
        ...
        "active_users": "Sesiones de Usuarios Activas",
        "username": "Usuario",
        "terminal": "Terminal",
        "host": "Host",
        ...
        "menu_opt4": "Skills de Soporte Especializado (MySQL, PostgreSQL, PowerBI, Docker, Web)",
