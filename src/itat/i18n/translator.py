...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "menu_opt4": "Specialized Support Skills (Diagnostic & Auto-Fix)",
        "menu_opt5": "Support Ticket Management (SQLite Helpdesk)",
        "menu_opt6": "Generate & Export Executive Reports (PDF / HTML)",
        "menu_exit": "Exit",
    ...
    "es": {
        ...
        "menu_opt4": "Skills de Soporte Especializado (Diagnóstico y Auto-Fix)",
        "menu_opt5": "Gestión de Tickets de Soporte (Helpdesk SQLite)",
        "menu_opt6": "Generar y Exportar Reportes Ejecutivos (PDF / HTML)",
        "menu_exit": "Salir",
